...
<article class="content">
    ...
    <div class="white-box">
        <div class="page-heading">
            Manage Subjects
            <a class="btn btn-primary pull-right" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#add-popup" title="Add Subject">Add Subject</a>
        </div>
        ...
        <div class="modal-body">
            <div class="job-portal" id="jobPortal">
               <div class="form-group">                   				
                    <div class="ff">
                       <a href="javascript:void(0);" id="btnAddC" class="btn btn-primary" title="Add Course" >Add Subjects</a>
                    </div>
                </div>
...
<input type="submit" value="Add Subject" class="btn btn-primary" title="Add Subject" id="btnSave" />			
...
<?php include 'footer.php';?>
	...
	$("#btnAddC").click(function(){
		debugger;
		$("#jobPortal").append('<div class="form-group"> <label class="control-label " for="sub'+acount+'">Subject '+acount+' Name:</label><div class="ff"><input type="text" class="form-control sub" id="sub'+acount+'" name="sub" ></div></div><div class="form-group"><label class="control-label " for="scode'+acount+'">Subject '+acount+' Code:</label><div class="ff"><input type="text" class="form-control scode" id="scode'+acount+'" name="scode" ></div></div>');		
	acount++;
	})
 ...
 $('#ul-naveSide').find('a').removeClass('active');
        $('#ul-naveSide').find('li:eq(4)').find('a').addClass('active');
    ...
    table = $('#example1').DataTable({
        ...
        "filter": true,
        "ajax": {
            "url": 'admin.php?action=getSubject',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
$(document).ready(function() {
	...
	initDatatable();
		...
		$(".sub").each(function () {	
			debugger;			
            var $this = $(this);
            var s = $("#sub"+lcount).val();
			 var sc = $("#scode"+lcount).val();
			lcount++;
			sub.push({"subject" :s, "scode":sc});		
        });

		
var jsonobj = JSON.stringify(sub);
